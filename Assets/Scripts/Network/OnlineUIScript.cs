...
public class OnlineUIScript : MonoBehaviour
{
    ...
    public OnlinePlayerSwitch _playerSwitch;
    ...
    private void Start()
    {
        ...
        _moveScript = GameObject.FindGameObjectWithTag("Player").GetComponent<OnlineMovementScript>();
