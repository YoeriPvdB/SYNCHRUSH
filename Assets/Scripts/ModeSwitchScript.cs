...
public class ModeSwitchScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _moveScript = gameObject.GetComponent<PlayerMovement>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.gameObject != null)
        {
            if (collision.gameObject.name == "ModeSwitch")
            {
                ...
                if (currentLevelChonk < _buildScript.chonks.Count)
                {
                    CheckMode();
    ...
    void Position()
    {
        foreach(GameObject lvlGo in _buildScript.chonks)
        {
            ...
            if(xDist <= 5f)
            {
                ...
                {
                    if (_moveScript.playerPositions == PlayerMovement.PlayerPositions.Top)
                    {
    ...
    void SplitIt()
    {
        ...
        _switchScript.playerChoice = PlayerSwitch.PlayerChoice.Player1;
    }
